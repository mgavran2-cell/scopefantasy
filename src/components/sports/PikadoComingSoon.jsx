...
export default function PikadoComingSoon({ onClose }) {
  ...
  return (
    ...
    >
      ...
      <h3 className="text-xl font-black mb-1">Pikado uskoro stiže na ScopeFantasy</h3>
      <p className="text-sm text-muted-foreground mb-5">
        Ostavi email da te obavijestimo kad aktiviramo pikado natjecanja
      </p>
