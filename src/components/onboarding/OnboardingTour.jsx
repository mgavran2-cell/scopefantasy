...
const STEPS = [
  {
    ...
    body: 'Igraj fantasy sport, predviđaj statistike igrača i osvajaj tokene. Imaš 5000 tokena za start. Vodimo te kroz osnove u par koraka.',
    btn: 'Krenimo →',
  },
  {
    emoji: '🎁',
    title: 'Welcome Challenge — 5000 dodatnih tokena',
    body: 'Pogodi sva 3 picka u Welcome Challenge-u i osvoji 5000 dodatnih tokena. Besplatno je — ne troši tvoju blagajnu.',
    btn: 'Idemo dalje →',
  },
  {
    emoji: '🎮',
    title: 'Sve igre na jednom mjestu — "Igraj"',
    body: 'U kartici Igraj imaš 5 načina: Pick\'em (predvidi ishode), Parlay (kombiniraj pickove), Izazovi (dnevni zadaci), Daily Streak (tjedni izazov) i Dueli (izazovi prijatelje 1-na-1).',
    btn: 'Idemo dalje →',
  },
  {
    emoji: '🔥',
    title: 'Vraćaj se svaki dan',
    body: 'Svaki dan dobiješ besplatne tokene (Daily Login Bonus) i jedan Pick dana (Daily Streak). Pogodi 7/7 u tjednu i osvoji 15.000 tokena!',
    btn: 'Idemo dalje →',
  },
  {
    emoji: '🧭',
    title: 'Kako se snalaziti',
    body: 'Tvoj balans tokena je gore desno (klikni za Novčanik). Pod "Više" su Profil, Prijatelji i Premium. Trebaš pomoć? Klikni ikonu ? u izborniku za FAQ.',
    btn: 'Idemo dalje →',
  },
  {
    emoji: '✨',
    title: 'Premium (uskoro)',
    body: 'Kasnije ćeš moći otključati AI Coach koji analizira tvoju igru, AI Analizu statistike i još. Za sad — sve je besplatno. Zabavi se!',
